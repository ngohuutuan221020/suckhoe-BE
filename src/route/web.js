...
let initWebRoutes = (app) => {
  ...
  router.post("/api/bulk-create-schedule", doctorController.bulkSreateSchedule);
  ...
  //veryfy email
  router.post("/api/verify-booking-appointment", patientController.postVerifyAppointment);
  //specialty
